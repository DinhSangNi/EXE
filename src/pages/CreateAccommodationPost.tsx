...
const AccommodationPostForm = ({ defaultLocation }: Props) => {
    ...
    return (
        <form onSubmit={handleSubmit(handleOnSubmit)}>
            ...
            {/* Category */}
            <div className="mb-8 w-full">
                <h1 className="mb-4 text-[1.2rem] font-bold">Chuyên mục</h1>
                <Controller
                    name="categoryId"
                    control={control}
                    render={({ field }) => (
            ...
            {/* Amenity */}
            <div className="mb-8">
                <h1 className="mb-4 text-[1.2rem] font-bold">Tiện ích</h1>
                <Controller
                    control={control}
                    name="amenityIds"
                    render={({ field }) => (
            ...
            {/* Image */}
            <div className="mb-8 w-full">
                <h1 className="mb-4 text-[1.2rem] font-bold">Hình ảnh</h1>
                <Controller
                    control={control}
                    name="imageIds"
                    render={({ field }) => (
            ...
            {/* Video */}
            <div className="mb-8 w-full">
                <h1 className="mb-4 text-[1.2rem] font-bold">Video</h1>
                {/* Video Url */}
                <div className="text-[0.9rem]">
                    <p className="mb-4">{`Video link (youtube/tiktok)`}</p>
                    <Controller
                    ...
                    />
                    <p>
                        <span className="font-bold">Lưu ý:</span> Bạn có thể
                        chọn video từ Youtube để hiển thị trên bài viết của
                        mình.
                    </p>
